    ...
    if ($_FILES["image"]["size"] > 0) {
        ...
        if ($uploadOk == 1) {
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
              ...
              $query = "UPDATE indoor_packages SET name='$name', description='$description', price='$price', capacity='$capacity', image='$target_file' WHERE id='$id'";
        ...
        $query = "UPDATE indoor_packages SET name='$name', description='$description', price='$price', capacity='$capacity' WHERE id='$id'";
        mysqli_query($con, $query);
    }
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM indoor_packages WHERE id='$id'";
